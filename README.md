...
> 🌐 **Живое демо (GitHub Pages):** **https://gebondar.github.io/geohim_analyze_platform/**
> (сайт самодостаточен — данные встроены в `docs/layers_data.js`).
...
- **Визуализация** — интерактивная веб‑карта на **MapLibre GL JS** (WebGL): 11 тематических слоёв
...
| 3. Исследование визуализации | обзор средств → выбор MapLibre GL JS |
